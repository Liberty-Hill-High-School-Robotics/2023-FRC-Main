...
public final XboxController operatorController = new XboxController(1);
  ...
  */
  ...
  m_chooser.addOption("turn180", new turn(m_drive));
  m_chooser.addOption("Place2Left", new Place2andCommunity(m_drive, m_claw, m_GoToTop, m_GoToStart, m_VerticalElevator, m_HorizontalElevator, m_HorizontalRotate, m_clawRotate));
