...
import frc.robot.commands.Place2andCommunity;
...
import frc.robot.commands.PlaceTopTaxiAndBalance;
...
public final XboxController operatorController = new XboxController(1);
  ...
  */
  ...
  m_chooser.addOption("PlaceTopAndBalance", new PlaceTopAndBalance(m_drive, m_claw, m_GoToTop, m_GoToStart, m_VerticalElevator, m_HorizontalElevator, m_HorizontalRotate, m_clawRotate, m_other));
  m_chooser.addOption("PlaceTopAndTaxiAndBalance", new PlaceTopTaxiAndBalance(m_drive, m_claw, m_GoToTop, m_GoToStart, m_VerticalElevator, m_HorizontalElevator, m_HorizontalRotate, m_clawRotate));
  
  m_chooser.addOption("turn180", new turn(m_drive));
  m_chooser.addOption("Place2Left", new Place2andCommunity(m_drive, m_claw, m_GoToTop, m_GoToStart, null, m_VerticalElevator, m_HorizontalElevator, m_HorizontalRotate, m_clawRotate));
  ...
  SmartDashboard.putData("RotateClawUp Command", new RotateClawUp(m_clawRotate));
    ...
    SmartDashboard.putData("turn180", new turn(m_drive));
    ...
    SmartDashboard.putData("diveBalance", new driveBalance(m_drive));
...
// Create some buttons
    ...
    buttonTurn90Left.onTrue(new driveTurnDegree(m_drive, 270));
