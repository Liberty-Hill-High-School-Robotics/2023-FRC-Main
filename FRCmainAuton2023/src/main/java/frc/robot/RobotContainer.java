...
// Create some buttons
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=BUTTONS
     // final JoystickButton buttonClawClose = new JoystickButton(driverJoystick, 1).whenPressed        
     //whileTrue(new clawClose(m_clawClose));
      
     
     
     Trigger buttonOpenClaw = new JoystickButton(operatorController, 6);
     
     buttonOpenClaw.whileTrue(new ClawOpen(m_claw));
     buttonOpenClaw.whileFalse(new ClawClose(m_claw));

     Trigger buttonRotateClawUp = new JoystickButton(operatorController, 4); 
     buttonRotateClawUp.onTrue(new RotateClawUp(m_claw));

     Trigger buttonRotateClawDown = new JoystickButton(operatorController, 1); 
