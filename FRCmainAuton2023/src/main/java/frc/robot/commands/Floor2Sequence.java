 ...
 *
 */
public class Floor2Sequence extends SequentialCommandGroup {

    // BEGIN AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS

    public Floor2Sequence(
        Claw claw,
        GoToFloor2Up goToFloor2Up,
        GoToFloor2Down goFloor2Down,
        GoToStart goToStart,
    ...
    addCommands(
        ...
        //      )    
        //  );
        new GoToFloor2Up(claw, verticalElevator, horizontalElevator, horizontalRotate, clawRotate),
        new GoToFloor2Down(claw, verticalElevator, horizontalElevator, horizontalRotate, clawRotate),
        new ClawClose(claw),
