 ...
 *
 */
public class PlaceTopTaxiAndBalance extends SequentialCommandGroup {

    // BEGIN AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS

    public PlaceTopTaxiAndBalance(
        Drive drive,
        Claw claw,
        GoToTop goToTop,
        GoToStart toStart,
    ...
    addCommands(
        ...
        new driveBackCharged(drive).withTimeout(4),
        new WaitCommand(1),
        new driveBackPastCharged(drive).withTimeout(2),
        new WaitCommand(2),
