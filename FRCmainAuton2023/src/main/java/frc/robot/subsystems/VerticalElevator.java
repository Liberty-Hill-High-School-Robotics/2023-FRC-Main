...
throughBorVE = new DutyCycleEncoder(1);
    ...
    public void VEGoTo(Constants.PlacementConstants.PlacementPosition position){
        ...
        if(throughBorVE.getAbsolutePosition() < targetPosition){
            VEDown();
            
            
        }else if(throughBorVE.getAbsolutePosition() > targetPosition){
   ...
   public boolean isVEAtPosition(){
        ...
        return Math.abs(throughBorVE.getAbsolutePosition() - targetPosition) <= error;
   }
