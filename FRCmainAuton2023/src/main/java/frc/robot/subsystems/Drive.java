...
/* 
private final RelativeEncoder encoderLB = cANSparkMAXLB.getEncoder(Type.kHallSensor, 42);
private final RelativeEncoder encoderRB = cANSparkMAXRB.getEncoder(Type.kHallSensor, 42);
private final RelativeEncoder encoderLF = cANSparkMAXLF.getEncoder(Type.kHallSensor, 42);
private final RelativeEncoder encoderRF = cANSparkMAXRF.getEncoder(Type.kHallSensor, 42);
*/
