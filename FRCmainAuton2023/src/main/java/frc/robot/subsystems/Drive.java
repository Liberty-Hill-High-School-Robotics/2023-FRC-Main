...
private final RelativeEncoder encoderLB = cANSparkMAXLB.getEncoder(Type.kQuadrature, 42);
private final RelativeEncoder encoderRB = cANSparkMAXRB.getEncoder(Type.kQuadrature, 42);
private final RelativeEncoder encoderLF = cANSparkMAXLF.getEncoder(Type.kQuadrature, 42);
private final RelativeEncoder encoderRF = cANSparkMAXRF.getEncoder(Type.kQuadrature, 42);
